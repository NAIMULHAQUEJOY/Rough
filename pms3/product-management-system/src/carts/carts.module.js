...
const cart_entity_1 = require("../entities/cart.entity"); // Make sure the path is correct
let CartsModule = class CartsModule {
};
exports.CartsModule = CartsModule;
exports.CartsModule = CartsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([cart_entity_1.Cart])], // Register the Cart repository
